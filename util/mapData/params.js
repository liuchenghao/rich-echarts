...
define(function (require) {
    ...
    var mapParams = {
        ...
        'world': {
            getGeoJson: function (callback) { 
              var md = require('./geoJson/world_geo');
                  callback(decode(md));
        ...
        '新疆': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/xin_jiang_geo');
                callback(decode(md));
            }
        },
        '西藏': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/xi_zang_geo');
                callback(decode(md));
            }
        },
        '内蒙古': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/nei_meng_gu_geo');
                callback(decode(md));
            }
        },
        '青海': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/qing_hai_geo');
                callback(decode(md));
            }
        },
        '四川': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/si_chuan_geo');
                callback(decode(md));
            }
        },
        '黑龙江': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/hei_long_jiang_geo');
                callback(decode(md));
            }
        },
        '甘肃': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/gan_su_geo');
                callback(decode(md));
            }
        },
        '云南': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/yun_nan_geo');
                callback(decode(md));
            }
        },
        '广西': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/guang_xi_geo');
                callback(decode(md));
            }
        },
        '湖南': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/hu_nan_geo');
                callback(decode(md));
            }
        },
        '陕西': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/shan_xi_1_geo');
                callback(decode(md));
            }
        },
        '广东': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/guang_dong_geo');
                callback(decode(md));
            }
        },
        '吉林': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/ji_lin_geo');
                callback(decode(md));
            }
        },
        '河北': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/he_bei_geo');
                callback(decode(md));
            }
        },
        '湖北': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/hu_bei_geo');
                callback(decode(md));
            }
        },
        '贵州': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/gui_zhou_geo');
                callback(decode(md));
            }
        },
        '山东': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/shan_dong_geo');
                callback(decode(md));
            }
        },
        '江西': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/jiang_xi_geo');
                callback(decode(md));
            }
        },
        '河南': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/he_nan_geo');
                callback(decode(md));
            }
        },
        '辽宁': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/liao_ning_geo');
                callback(decode(md));
            }
        },
        '山西': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/shan_xi_2_geo');
                callback(decode(md));
            }
        },
        '安徽': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/an_hui_geo');
                callback(decode(md));
            }
        },
        '福建': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/fu_jian_geo');
                callback(decode(md));
            }
        },
        '浙江': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/zhe_jiang_geo');
                callback(decode(md));
            }
        },
        '江苏': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/jiang_su_geo');
                callback(decode(md));
            }
        },
        '重庆': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/chong_qing_geo');
                callback(decode(md));
            }
        },
        '宁夏': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/ning_xia_geo');
                callback(decode(md));
            }
        },
        '海南': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/hai_nan_geo');
                callback(decode(md));
            }
        },
        '台湾': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/tai_wan_geo');
                callback(decode(md));
            }
        },
        '北京': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/bei_jing_geo');
                callback(decode(md));
            }
        },
        '天津': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/tian_jin_geo');
                callback(decode(md));
            }
        },
        '上海': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/shang_hai_geo');
                callback(decode(md));
            }
        },
        '香港': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/xiang_gang_geo');
                callback(decode(md));
            }
        },
        '澳门': {
            getGeoJson: function (callback) { 
                ...
                //     callback(decode(md));
                // });
                var md = require('./geoJson/ao_men_geo');
                callback(decode(md));
            }
        }
    };
